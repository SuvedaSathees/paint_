...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Akshara Paints & Hardware" },
      { name: "description", content: "Premium paints, tools and hardware for spaces built to last." },
      { name: "author", content: "Akshara Paints & Hardware" },
      { property: "og:title", content: "Akshara Paints & Hardware" },
      { property: "og:description", content: "Premium paints, tools and hardware for spaces built to last." },
